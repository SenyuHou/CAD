...
class Voc2007Classification(data.Dataset):
    def __init__(self, root, set_name, img_size, transform=None, target_transform=None, noise_type = 'symmetric', noise_rate=0.3, split_per=0.9, nb_classes=20 ,random_seed=1):
        self.root = root
